...
const columns = [
  ...
  { name: "节点名称", uid: "name", sortable: true },
  { name: "所属组织", uid: "organization" },
...
export default function NodeCenter() {
  ...
  return (
    <div className="flex-1 p-8">
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-white">节点管理</h1>
      </div>
            ...
            <>
              ...
              <ModalBody>
                <p className="text-white/90">
                  确定要删除节点 "{nodeToDelete?.name}" 吗？此操作无法撤销。
                </p>
              </ModalBody>
              <ModalFooter>
                <Button 
